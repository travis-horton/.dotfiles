...
RPS1='${${(%):-%~}//\//${PR_BOLD_RED}/%b${PR_BOLD_BLUE}}%b$PR_BOLD_BLUE'
...
alias t='tree -alCF -I ".git|node_modules|dist|target|.cache"'  #makes tree colorized, follow symbolic links, show trailing char for types, and ignore a bunch of things
